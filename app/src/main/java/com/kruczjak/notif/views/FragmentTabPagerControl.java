...
import com.kruczjak.notif.frags.MessageOverviewFragment;
import com.kruczjak.notif.frags.NotifFragment;
...
public class FragmentTabPagerControl extends FragmentPagerAdapter implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
    ...
    private com.kruczjak.notif.frags.MessageOverviewFragment MessageOverviewFragment = new MessageOverviewFragment();
    private com.kruczjak.notif.frags.NotifFragment NotifFragment = new NotifFragment();
