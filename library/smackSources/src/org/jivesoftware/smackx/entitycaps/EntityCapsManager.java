...
public class EntityCapsManager {
     ...
     *
     * @param nodeVer The node and verification String (e.g.
     ...
     *
     * @param nodeVer The node name (e.g.
     *                "http://psi-im.org#q07IKJEyjvHSyhy//CH0CxmKi8w=").
     ...
     *
     * @param discoverInfo the local users discover info (mostly the service discovery
     *                     features)
