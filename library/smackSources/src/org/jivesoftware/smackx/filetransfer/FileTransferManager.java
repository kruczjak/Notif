...
public class FileTransferManager {
     ...
     *
     * @param connection The Connection that the file transfers will use.
     */
     ...
     *
     * @param li The file transfer listener to be removed
     * @see FileTransferListener
     */
     ...
     *
     * @param userID The fully qualified jabber ID (i.e. full JID) with resource of the user to
     *               send the file to.
     * @return The send file object on which the negotiated transfer can be run.
     * @throws IllegalArgumentException if userID is null or not a full JID
     */
